...
public:
	...
	virtual void sendRejectCommandEventRequestAction(CreateCommandEvent msg, Receive::Body::ReceiveRec transportData);
	...
	virtual void timeoutConfirmEventRequestAction();
