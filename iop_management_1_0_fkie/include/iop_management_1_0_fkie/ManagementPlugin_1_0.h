...
#ifndef MANAGEMENTPLUGIN_1_0_H
#define MANAGEMENTPLUGIN_1_0_H
...
class DllExport ManagementPlugin_1_0 : public PluginInterface
{
public:
	ManagementPlugin_1_0();
	...
	virtual ~ManagementPlugin_1_0();

	jVariableLengthString get_service_uri() { return "urn:jaus:jss:core:Management"; }
	jUnsignedByte get_version_number_major() { return 1; }
	jUnsignedByte get_version_number_minor() { return 0; }

protected:
	urn_jaus_jss_core_Management_1_0::ManagementService *p_my_service;
