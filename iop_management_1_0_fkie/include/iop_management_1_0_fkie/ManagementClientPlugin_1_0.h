...
#ifndef MANAGEMENTCLIENTPLUGIN_1_0_H
#define MANAGEMENTCLIENTPLUGIN_1_0_H
...
class DllExport ManagementClientPlugin_1_0 : public PluginInterface
{
public:
	ManagementClientPlugin_1_0();
	...
	virtual ~ManagementClientPlugin_1_0();

	jVariableLengthString get_service_uri() { return "urn:jaus:jss:core:ManagementClient"; }
	jUnsignedByte get_version_number_major() { return 1; }
	jUnsignedByte get_version_number_minor() { return 0; }

protected:
	urn_jaus_jss_core_ManagementClient_1_0::ManagementClientService *p_my_service;
