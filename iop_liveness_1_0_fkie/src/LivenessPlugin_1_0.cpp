...
LivenessPlugin_1_0::LivenessPlugin_1_0()
{
	p_my_service = NULL;
...
JTS::Service* LivenessPlugin_1_0::get_iop_service()
{
	return p_my_service;
}

const std::type_info & LivenessPlugin_1_0::get_iop_service_type()
{
	return typeid(LivenessService);
}

const std::type_info & LivenessPlugin_1_0::get_base_service_type()
{
	return typeid(EventsService);
}


void LivenessPlugin_1_0::create_jts_service(JTS::JausRouter* jaus_router)
{
...
PLUGINLIB_EXPORT_CLASS(iop::LivenessPlugin_1_0, iop::PluginInterface)
