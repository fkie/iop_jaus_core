...
#ifndef LIVENESSPLUGIN_1_0_H
#define LIVENESSPLUGIN_1_0_H
...
class DllExport LivenessPlugin_1_0 : public PluginInterface
{
public:
	LivenessPlugin_1_0();
	...
	virtual ~LivenessPlugin_1_0();

	jVariableLengthString get_service_uri() { return "urn:jaus:jss:core:Liveness"; }
...
protected:
	...
	urn_jaus_jss_core_Liveness_1_0::LivenessService *p_my_service;
